...
#define TERMINAL_URGENT_BUFFER_TASK_SIZE 512
...
// Radio
#define REMOTE_TERMINAL_INPUT_DISABLED
#define RADIO_HEADER "ATH"
#define RADIO_HEADER_LENGTH 3
...
#define FS_NEW_FILE_THRESHOLD (32 * 1024)
